...
export class PharmacistService {
    constructor(
        @InjectModel(Pharmacist.name) private readonly pharmacistModel: Model<Pharmacist>,
    ) { }
    ...
    async deletePharmacist(id: string) {
        return await this.pharmacistModel.findByIdAndUpdate(id, { isDeleted: true }).lean();
    }
