...
export class PharmacistController {
  ...
  async registerPharmacist(
    @Body() registerPharmacistDto: RegisterPharmacistDto,
  ) {
    return {
      data: await this.pharmacistService.registerPharmacist(
        registerPharmacistDto,
      ),
  ...
  async updatePharmacist(
    @Param('id') id: string,
    @Body() updatePharmacistDto: RegisterPharmacistDto,
  ) {
    return {
      data: await this.pharmacistService.updatePharmacist(
        id,
        updatePharmacistDto,
      ),
      message: 'Pharmacist updated successfully',
